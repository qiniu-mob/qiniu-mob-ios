...
typedef NS_ENUM(NSInteger, AWSRegionType) {
     ...
     *  QN CNNorth1 (CN)
     */
    QNRegionCNNorth1 NS_SWIFT_NAME(CNNorth1),
    /**
     *  QN CNEast1 (CN)
     */
    QNRegionCNEast1 NS_SWIFT_NAME(CNEast1),
    /**
     *  QN CNSorth1 (CN)
     */
    QNRegionCNSouth1 NS_SWIFT_NAME(CNSouth1),
};
...
typedef NS_ENUM(NSInteger, AWSServiceType) {
    ...
    /**
     *  QN Security Token Service (MOB)
     */
    QNServiceMOB NS_SWIFT_NAME(MOB),
};
